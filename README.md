...
| **Structure** | [Insert rows/columns](https://github.com/antnardo/odsslicer/blob/master/DOCS.md#inserting-rows-and-columns) — formula references and merges follow | `sheet.insert_rows(2, 5)` |
| | [Delete rows/columns](https://github.com/antnardo/odsslicer/blob/master/DOCS.md#deleting-rows-and-columns) — formula references follow, batchable | `sheet.delete_rows([3, 7, 20])` |
